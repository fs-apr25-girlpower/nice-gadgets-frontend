...
export const CustomerBar = () => {
  ...
  const menuClassName = 'text-[#89939A] text-[12px] font-bold';
  ...
  const itemClassName =
    'h-10 hover:text-[#000000] transition-colors duration-300 ease-in-out';
  ...
  return (
    <div className="flex flex-row items-center  h-full  border-l border-r border-[#E2E6E9]">
      <NavLink
      ...
      <div className="w-12 h-12 tablet:w-16 tablet:h-16 flex items-center justify-center border-r border-[#E2E6E9] tablet:hidden">
        <Menu
          right
          isOpen={isMobile}
        ...
        {isMobile && (
          <div className="flex flex-row w-full h-16 fixed bottom-0 left-0 right-0  border-[#E2E6E9]">
            <NavLink
              to={'/favourites'}
              className={
